...
func (_m *MockService) FindFirstOne() (*Channel, error) {
	ret := _m.Called()
...
func (_m *MockService) FindManyByThreshold(threshold int) ([]Channel, error) {
...
func (_m *MockService) UpdateThreshold(threshold int) error {
	ret := _m.Called(threshold)
